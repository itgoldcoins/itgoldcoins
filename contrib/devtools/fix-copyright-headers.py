...
// Copyright (c) 2009-2012 The Itgoldcoins Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Itgoldcoins/$1-%s The Itgoldcoins/' %s"
REGEX_CURRENT= re.compile("%s The Itgoldcoins" % year)

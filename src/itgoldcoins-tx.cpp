...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Itgoldcoins Core itgoldcoins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  itgoldcoins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded itgoldcoins transaction") + "\n" +
              "  itgoldcoins-tx [options] -create [commands]   " + _("Create hex-encoded itgoldcoins transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const string& strInput)
{
    ...
    CItgoldcoinsAddress addr(strAddr);
    if (!addr.IsValid())
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded itgoldcoins transaction

...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/itgoldcoins"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Itgoldcoins Core"),
     ...
     * override -datadir in the itgoldcoins.conf file in the default data directory
     * (to be consistent with itgoldcoinsd behavior)
     */
    if(dataDir != getDefaultDataDirectory())

// Copyright (c) 2013-2015 The Itgoldcoins Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CItgoldcoinsAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CItgoldcoinsAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CItgoldcoinsAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CItgoldcoinsAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CItgoldcoinsAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CItgoldcoinsAddress(arr[0].get_str()).Get() == demoAddress.Get());

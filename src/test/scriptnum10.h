...
#ifndef ITGOLDCOINS_TEST_SCRIPTNUM10_H
#define ITGOLDCOINS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Itgoldcoins Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ITGOLDCOINS_TEST_BIGNUM_H
